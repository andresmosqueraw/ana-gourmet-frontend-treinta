...
describe('ClienteService', () => {
  ...
  const apiUrl = 'http://localhost:8100/api/customer/all';
  const createUrl = 'http://localhost:8100/api/customer/create';
  const searchUrl = 'http://localhost:8100/api/customer/search';
  const deleteUrl = 'http://localhost:8100/api/customer/delete';
  const updateUrl = 'http://localhost:8100/api/customer/update';
