...
describe('InventoryService', () => {
  ...
  const apiUrl = 'http://localhost:8201/api/inventory/all';
  const createUrl = 'http://localhost:8201/api/inventory/create';
  const searchUrl = 'http://localhost:8201/api/inventory/search';
  const deleteUrl = 'http://localhost:8201/api/inventory/delete';
  const updateUrl = 'http://localhost:8201/api/inventory/update';
