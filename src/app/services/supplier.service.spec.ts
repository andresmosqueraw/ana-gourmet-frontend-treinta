...
describe('SupplierService', () => {
  ...
  const apiUrl = 'http://localhost:8090/api/supplier/all';
  const createUrl = 'http://localhost:8090/api/supplier/create';
  const searchUrl = 'http://localhost:8090/api/supplier/search';
  const deleteUrl = 'http://localhost:8090/api/supplier/delete';
  const updateUrl = 'http://localhost:8090/api/supplier/update';
